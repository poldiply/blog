...
our %config = (
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--prefix=/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/build no-acvp-tests no-afalgeng no-apps no-asan no-asm no-brotli no-brotli-dynamic no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-default-thread-pool no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-engine no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-padlockeng no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tests no-tfo no-thread-pool no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "0",
    ...
    "perlargv" => [
        ...
        "no-tests",
        "no-apps",
        "--prefix=/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/build"
    ],
    "perlenv" => {
        "AR" => "emar",
        "ARFLAGS" => undef,
...
unless (caller) {
    ...
    use lib '/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/util/perl';
    use OpenSSL::fallback '/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/Configurations';
        use gentemplate;
