...
BEGIN {
    ...
    require '/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/cslee/Desktop/cslee/00.cslee/dev-cs/blog/wasm-build/openssl/test/fips-and-base.cnf';
    shift;
